---
title: "GSE29614 Microarray Processing (RMA → Gene-level median)"
author: "Pramod"
output:
  html_document:
    toc: true
...
base_dir = "/home/pshinde/repos/cmi-flu/transcriptomics/microarray/GSE29614/"
```
...
```{r save}
out_dir <- "output_GSE29614"
dir.create(out_dir, showWarnings = FALSE)
readr::write_csv(as.data.frame(exprs_mat), file.path(out_dir, "GSE29614_probe_expression_RMA.csv"))
readr::write_csv(gene_expr, file.path(out_dir, "GSE29614_gene_median_expression.csv"))

# phenotype data for downstream analysis
pheno <- Biobase::pData(eset)
readr::write_csv(as.data.frame(pheno), file.path(out_dir, "GSE29614_pheno.csv"))
