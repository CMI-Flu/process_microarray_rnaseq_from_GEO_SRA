---
title: "GSE74817 Microarray Processing (RMA → Gene-level median)"
author: "Pramod"
output:
  html_document:
    toc: true
...
base_dir = "/home/pshinde/repos/cmi-flu/transcriptomics/microarray/GSE74817_CEL/"
```
...
```{r save}
out_dir <- "output_GSE74817"
dir.create(out_dir, showWarnings = FALSE)
readr::write_csv(as.data.frame(exprs_mat), file.path(out_dir, "GSE74817_probe_expression_RMA.csv"))
readr::write_csv(gene_expr, file.path(out_dir, "GSE74817_gene_median_expression.csv"))

# phenotype data for downstream analysis
pheno <- Biobase::pData(eset)
readr::write_csv(as.data.frame(gse@gpls$GPL13158@dataTable@table ), file.path(out_dir, "GSE74817_pheno.csv"))
