---
title: "GSE120719 Microarray Processing (RMA → Gene-level median)"
author: "Pramod"
output:
  html_document:
    toc: true
...
base_dir = "/home/pshinde/repos/cmi-flu/transcriptomics/microarray/GSE120719_CEL/"
```
...
```{r annotate}
# Map Affy probe IDs (row names) to HGNC gene symbols
#probe_to_gene <- AnnotationDbi::select(hgu133plus2.db,
...
```{r save}
out_dir <- "output_GSE120719"
dir.create(out_dir, showWarnings = FALSE)
readr::write_csv(as.data.frame(exprs_mat), file.path(out_dir, "GSE120719_probe_expression_RMA.csv"))
readr::write_csv(gene_expr, file.path(out_dir, "GSE120719_gene_median_expression.csv"))

# phenotype data for downstream analysis
pheno <- Biobase::pData(eset)
readr::write_csv(as.data.frame(gse@gpls$GPL13158@dataTable@table ), file.path(out_dir, "GSE120719_pheno.csv"))
